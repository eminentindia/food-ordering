...
$getfaq = getsinglefaq($conn, $ID);
$getfaq = json_decode($getfaq, true);
foreach ($getfaq as $key => $getsinglefaq) {
    extract($getsinglefaq);
}
...
<div class="page-wrapper">
    ...
    <div class="container-fluid">
        <!-- -------------Content Here------------- -->
        <div class="card">
            <form class="form-horizontal" action="action/update-faq.php" method="POST" enctype="multipart/form-data" onsubmit="return Updatefaq()">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            ...
                            <textarea class="form-control" name="a" id="a"><?php echo $a; ?></textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="fname" class="col-sm-3  control-label col-form-label">Display Priority</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="display_priority" id="display_priority" value="<?php echo $display_priority; ?>">
                        </div>
                    </div>
