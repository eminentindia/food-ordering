...
$res = mysqli_query($conn, "Select * from  orders JOIN order_status  ON orders.order_status=order_status.order_status_id  where  order_added_on between '$start' and '$end'");
?>
        ...
        <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
                ...
                <a href="<?= ADMIN_SITE_PATH ?>order/today-order.php">
                    <h4 class="btn btn-primary waves-effect waves-dark" style="margin-right: 25px;"> Today Orders</h4>
                </a>
