...
if (isset($_POST['OTP'])) {
    ...
    if ($_POST['OTP'] == 'cancel') {
        ...
        if (mysqli_num_rows($result) > 0) {
            $update = "UPDATE  orders set paymentstatus='cancel', is_payment_success='0' WHERE order_id='" . $order_id . "'";
        ...
        $result = mysqli_query($conn, $sql);
        if (mysqli_num_rows($result) > 0) {
            $update = "UPDATE  orders set paymentstatus='refunded', is_payment_success='0' WHERE order_id='" . $order_id . "'";
            mysqli_query($conn, $update);
            echo ' <meta http-equiv="refresh" content="0">';
        }
    } else {
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            $update = "UPDATE  orders set paymentstatus='captured', otp_validate='1', delievered_on='$d_on' WHERE order_id='" . $order_id . "'";
            mysqli_query($conn, $update);
            $validated = true;
                ...
                <div class="ms-auto text-end">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="<?php echo ADMIN_SITE_PATH; ?>order/orders.php">Orders</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Order <?php echo $order_id; ?> Details</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="card">
            <div class="card-body table-responsive">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <a href="<?php echo SITE_PATH ?>download-invoice.php?id=<?php echo $orderID ?>"><button class="btn btn-warning"><i class="fa fa-download" aria-hidden="true"></i>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.success == true) {
                            ...
                            $("#ordr_status_success").delay(4000).fadeOut("slow");
                            $("#efwe").html(Orderhtml);
                        }
                    },
                    complete: function() {
