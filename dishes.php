...
<body class="template-collection belle">
        ...
        <div class="collection-header">
            <div class="collection-hero">
                ...
                <div class="collection-hero__title-wrapper">
                    <h1 class="collection-hero__title page-width">Popular Dishes</h1>
                </div>
            </div>
        </div>
                            ...
                            <div class="filters-toolbar-wrapper">
                                <div class="row justify-content-between">
                                    <div class="col-4 col-md-4 col-lg-4  filters-toolbar__item filters-toolbar__item--count">
                                        <span class="filters-toolbar__product-count"> <a href="<?= SITE_PATH ?>"><i class="fa fa-home"></i></a> <i class="fa fa-angle-right"></i> Dishes
                                    </div>
    ...
    <script>
        ...
        function loadDishes(page) {
            ...
            loading = true;
            $.ajax({
                url: SITE_PATH + 'action/load_dishes.php',
                type: 'POST',
                data: {
                    page: page,
                    type: selectedType,
