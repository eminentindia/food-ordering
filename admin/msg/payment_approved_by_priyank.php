...
if(isset($send_payment_to_whatsapp) AND $send_payment_to_whatsapp != ""){
    $sql = "SELECT *, payby.admin_name As pby, payby.admin_mobile As pby_mobile, payto.payee_name As pto, lby.admin_name As listby, lby.admin_mobile As listby_mobile FROM pay 
    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            ...
            $mobile=$row['pby_mobile'];
        }
    }
    if($value15!="Net Banking"){
        $response = $client->request('POST','whatsapp/1/message/template',[ RequestOptions::JSON => ['messages' => [
            [
                'from' => '918303353169',
                'to' => '91'.$mobile,
                'content' => [
                    ...
                    'templateData' => [
                        'body' => [
                            'placeholders' => [$value1, $value2, $value3, $value4, $value5, $value6, $value7, $value8, $value9, $value10, $value11, $value12, $value13, $value14, $value15, $value16, 'Subhan Faruqui']
                        ],
