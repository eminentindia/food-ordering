...
<div id="kt_explore" class="bg-body mt-0" data-kt-drawer="true" data-kt-drawer-name="explore" data-kt-drawer-activate="true" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'100%', 'lg': '475px'}" data-kt-drawer-direction="end" data-kt-drawer-toggle="#add_leave_modal" data-kt-drawer-close="#kt_explore_close">
            ...
            <div id="kt_explore_scroll" class="scroll-y me-n5 pe-5" data-kt-scroll="true"  data-kt-scroll-wrappers="#kt_explore_body" data-kt-scroll-dependencies="#kt_explore_header" data-kt-scroll-offset="5px">
                ...
                <form id="leaveForm" class="form fv-plugins-bootstrap5 fv-plugins-framework">
                    <div class="d-flex flex-column mb-7 fv-row fv-plugins-icon-container">
                        ...
                        <input required type="text" class="form-select form-select-solid fw-bolder form-control form-control-solid cursor-pointer" name="leave_date" placeholder="Pick date range" id="kt_daterangepicker_2">
                    </div>
                    ...
                    <div class="d-flex flex-column border-bottom mb-8 fv-row">
                        ...
                        <?php
                        $employee = '<select name="emp_id" id="add_leave_select2" class="form-control" data-control="select2" required>';
                    ...
                    <div class="d-flex flex-column fv-row fv-plugins-icon-container border border-dashed bg-light-success border-success p-3">
                        <label class="d-flex align-items-center fs-6 fw-bold form-label mb-2">
                            ...
                            <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="" data-bs-original-title="It will updated in the attendance also !!" aria-label="Assign leave status"></i>
                        </label>
