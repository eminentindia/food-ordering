...
if (!isset($_SESSION['cart']) || empty($_SESSION['cart'])) {
    ...
    if (isset($_GET['ORDERID']) and $_GET['ORDERID'] != "") {
        $_SESSION['ORDER_ID'] = $order_id = $_GET['ORDERID'];
    } else {
    ...
    try {
        ...
        // Callback URL
        $callbackUrl = "" . SITE_PATH . "razorpay/verify.php?ORDERID=" . $order_id; // Replace with your actual callback URL
        ...
        $data = [
            ...
            "image"             => "https://foodieez.co.in/images/logo.png",
            "prefill"           => [
                "name"              => $fname,
                "email"             => $email,
                "contact"           => $phone,
    ...
    <div class="container-contact100">
        <div class="bg">
            <div class="card p-0">
                ...
                <h1 class="card__msg pt-3">You are paying<br><span class="card__price"><span>&#8377;<?php echo $coupon_code_apply ?></span></h1>
    ...
    padding-top: 0;">
                  ...
                  border-top: 1px dashed #fd7d16;">' . $i++ . '. ';
                    ...
                    <div class="payment" style=" margin-top: 40px !IMPORTANT;">
                        ...
                        <form action="verify.php?ORDERID=<?php echo $order_id; ?>" method="POST" name="member_signu">
